...
export function IconTheme() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <path d="M12 3a9 9 0 1 0 9 9c0-.46-.04-.92-.1-1.36a5.5 5.5 0 0 1-4.4 2.26 5.5 5.5 0 0 1-5.54-5.54A5.5 5.5 0 0 1 10.36 3.1 9 9 0 0 0 12 3z" />
    </svg>
  );
}
